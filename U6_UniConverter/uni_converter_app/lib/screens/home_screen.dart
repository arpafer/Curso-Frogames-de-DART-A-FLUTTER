...
class HomeState extends State<HomeScreen> {
  ...
  String _gramoFuerzaValue = "0.0";
  String _kilonewtonValue = "0.0";
  String _libraFuerzaValue = "0.0";
  String _kilogramoFuerzaValue = "0.0";
  String _dinaValue = "0.0";
                ...
                children: [
                  ListTile(
                   ...
                   ListTile(
                    ...
                    trailing: Text(_kilogramoFuerzaValue)
                  ),
                   ListTile(
                    ...
                    trailing: Text(_libraFuerzaValue)
                  ),
                   ListTile(
                    ...
                    trailing: Text(_kilonewtonValue)
                  ),
                   ListTile(
                    ...
                    trailing: Text(_gramoFuerzaValue)
                  ),
                  ListTile(
